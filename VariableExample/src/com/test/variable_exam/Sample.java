	...
	public static void main(String args[]){
	 ...
	 while(){
			 ...
			 if(a1 == a2)	{
		 		...
		 		System.out.println("8∂Ø");
		 		res_a = 18;
				 }
				 else if(a1 == 9 &  a2==9){
		 		System.out.println("9∂Ø");
		 		res_a = 19;
				 }
	 ...
	 if (res_a > res_b)
		 System.out.println("a∞° ¿Ã∞ÂΩ¿¥œ¥Ÿ.");
	 if(res_a < res_b)
			 System.out.println("b∞° ¿Ã∞ÂΩ¿¥œ¥Ÿ.");
		 if(res_a == res_b)
			 System.out.println("aøÕ b∞° ∫Ò∞ÂΩ¿¥œ¥Ÿ.");
